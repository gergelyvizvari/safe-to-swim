...
const lakeMessages = {"en": {"filter": "Water type", "all": "All", "coastal": "Sea", "lake": "Lake", "label": "Lake bathing site", "title": "Check lake conditions on site.", "description": "Weather and annual water quality are available. Lake water temperature, waves, currents and algae conditions are not monitored here; no swim recommendation is provided.", "forecast": "Weather forecast", "air": "Air temperature"}, "hu": {"filter": "Víztípus", "all": "Mind", "coastal": "Tenger", "lake": "Tó", "label": "Tavi fürdőhely", "title": "Ellenőrizd a tó állapotát a helyszínen.", "description": "Időjárás és éves vízminősítés érhető el. A tó vízhőmérsékletét, hullámzását, áramlásait és algásodását itt nem mérjük; úszási ajánlást nem adunk.", "forecast": "Időjárás-előrejelzés", "air": "Levegő hőmérséklete"}, "fr": {"filter": "Type d’eau", "all": "Tous", "coastal": "Mer", "lake": "Lac", "label": "Baignade en lac", "title": "Vérifiez les conditions du lac sur place.", "description": "Météo et qualité annuelle disponibles. La température du lac, les vagues, les courants et les algues ne sont pas suivis ici ; aucune recommandation de baignade.", "forecast": "Prévisions météo", "air": "Température de l’air"}, "it": {"filter": "Tipo di acqua", "all": "Tutti", "coastal": "Mare", "lake": "Lago", "label": "Balneazione lacustre", "title": "Controlla le condizioni del lago sul posto.", "description": "Meteo e qualità annuale disponibili. Temperatura del lago, onde, correnti e alghe non sono monitorate qui; nessuna raccomandazione di balneazione.", "forecast": "Previsioni meteo", "air": "Temperatura dell’aria"}, "es": {"filter": "Tipo de agua", "all": "Todos", "coastal": "Mar", "lake": "Lago", "label": "Zona de baño en lago", "title": "Comprueba el estado del lago en el lugar.", "description": "Hay datos meteorológicos y calidad anual. No se monitorizan temperatura del lago, olas, corrientes ni algas; no se ofrece recomendación de baño.", "forecast": "Previsión meteorológica", "air": "Temperatura del aire"}}
