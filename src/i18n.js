...
const translations = {
  ...
  fr: {
    ...
    locationPicker: { title: 'Choisir une plage', subtitle: 'Recherchez parmi {count} lieux côtiers britanniques', searchLabel: 'Rechercher une plage', searchPlaceholder: 'Plage, ville ou région…', useLocation: 'Trouver la plage la plus proche', current: 'Plage sélectionnée', suggested: 'Plages populaires', results: '{count} résultats', empty: 'Aucune plage ne correspond à cette recherche.', refine: 'Les {count} premiers résultats sont affichés. Précisez votre recherche.', selected: 'Sélectionnée', close: 'Fermer le sélecteur de plage', viewLabel: 'Choisir la vue des plages', listView: 'Liste', mapView: 'Carte', mapAria: 'Carte des lieux côtiers britanniques', mapLoading: 'Chargement de la carte…', mapEmpty: 'Aucune plage ne correspond à cette recherche.', resetMap: 'Tout le Royaume-Uni', selectMapLocation: 'Choisir cette plage', clusterLabel: '{count} plages — agrandir', previewLoading: 'Chargement des conditions…', previewUnavailable: 'Aperçu indisponible', previewAria: 'Aperçu des conditions de baignade', distanceAway: 'à {distance} km' },
    explorer: {
  ...
  it: {
    ...
    locationPicker: { title: 'Scegli una spiaggia', subtitle: 'Cerca tra {count} località costiere del Regno Unito', searchLabel: 'Cerca spiagge', searchPlaceholder: 'Spiaggia, città o zona…', useLocation: 'Trova la spiaggia più vicina', current: 'Spiaggia selezionata', suggested: 'Spiagge popolari', results: '{count} risultati', empty: 'Nessuna spiaggia corrisponde alla ricerca.', refine: 'Sono mostrati i primi {count} risultati. Affina la ricerca.', selected: 'Selezionata', close: 'Chiudi il selettore spiaggia', viewLabel: 'Scegli la vista delle spiagge', listView: 'Elenco', mapView: 'Mappa', mapAria: 'Mappa delle località costiere del Regno Unito', mapLoading: 'Caricamento mappa…', mapEmpty: 'Nessuna spiaggia corrisponde alla ricerca.', resetMap: 'Tutto il Regno Unito', selectMapLocation: 'Scegli spiaggia', clusterLabel: '{count} spiagge — ingrandisci', previewLoading: 'Caricamento condizioni…', previewUnavailable: 'Anteprima non disponibile', previewAria: 'Anteprima delle condizioni della spiaggia', distanceAway: 'a {distance} km' },
    explorer: {
      eyebrow: 'Acque di balneazione costiere', title: 'Esplora tutta la costa', count: '{count} siti costieri verificati', searchLabel: 'Cerca spiagge costiere', searchPlaceholder: 'Spiaggia, città o zona…', filterLabel: 'Filtra per nazione', results: '{count} località trovate', empty: 'Nessuna località costiera corrisponde.', refine: 'Affina la ricerca per vedere più risultati.', reset: 'Tutto il Regno Unito', mapLabel: 'Mappa delle acque di balneazione costiere ufficiali', classification: 'Qualità dell’acqua: {value}', modelLocation: 'Condizioni modello disponibili', selectedLocation: 'Località selezionata', excellent: 'Eccellente', good: 'Buona', sufficient: 'Sufficiente', poor: 'Scarsa',
